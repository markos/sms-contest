// $Id: client_handler.h,v 2.5 2003/08/25 08:32:49 markos Exp $
...
/**
	...
	*@brief	The ACE Client Handler (used by the acceptor)
...
/// We have to forward define the classes to be able to use it.
