...
/**
  * The only useful method for the user. getCRC() is given a buffer
  * called data for which it calculates and returns the CRC. The buffer
  * MUST be of type unsigned char * (casting is ok).
  */
